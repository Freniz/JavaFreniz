...
HashMap ud=obj.getUserDetails("meeran");
...
for(int i=0;i<5000;i++)
  {
  obj.doPost("meeran", "meeran", "hiiiiiii");
  }
...
out.print(obj.getUnreadMessageCount("meeran")+"<br>");
out.print(obj.getSentMessages("meeran"));
