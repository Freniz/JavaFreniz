<%-- 
    Document   : writeslambook
    Created on : Dec 28, 2011, 11:23:28 PM
    Author     : abdulnizam
--%>
...
<td></td><td><input type="button" name="create" value="Create" onclick="writeslambook('<%out.print(request.getParameter("userid"));%>')" /></td></tr>
</table>
</form>
</div>
